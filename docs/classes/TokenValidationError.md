[magellanic-sdk](../README.md) / [Exports](../modules.md) / TokenValidationError
...
[src/client/errors/token-validation.error.ts:2](https://gitlab.com/magellanic/platform/magellanic-ciem/magellanic-ciem-sdk/-/blob/0b7d1b6/src/client/errors/token-validation.error.ts#L2)
